    ...
    <div style={{ height:"100%", overflowY:"auto", background:C.bg, fontFamily:C.inter }}>
      ...
      <div style={{ minHeight:"90vh", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"80px 24px 60px", textAlign:"center", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ position:"relative", zIndex:1, maxWidth:"680px" }}>
          ...
          <h1 style={{ color:C.text, fontSize:"clamp(18px,3.5vw,26px)", fontWeight:300, lineHeight:1.5, margin:"0 0 14px", letterSpacing:"-0.01em", fontFamily:C.inter }}>
            Real-time drone, vehicle &amp; personnel<br />
            <strong style={{ fontWeight:700 }}>tracking simulator</strong>
          </h1>

          <p style={{ color:C.muted, fontSize:"clamp(13px,1.8vw,15px)", lineHeight:1.7, maxWidth:"500px", margin:"0 auto 44px", fontFamily:C.inter }}>
          ...
          <div style={{ display:"flex", gap:"12px", justifyContent:"center", flexWrap:"wrap" }}>
            <button onClick={() => onNav("simulator")}
              style={{ background:C.red, border:"none", color:"#fff", fontFamily:C.font, fontSize:"11px", fontWeight:700, letterSpacing:"0.22em", textTransform:"uppercase", padding:"14px 36px", cursor:"pointer", transition:"opacity 0.15s" }}
      ...
      <div style={{ maxWidth:"960px", margin:"0 auto", padding:"80px 24px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))", gap:"1px", background:C.border }}>
          {FEATURES.map(({ icon, label, desc }) => (
            <div key={label} style={{ background:C.bg, padding:"28px 24px", transition:"background 0.15s", cursor:"default" }}
              onMouseOver={e => (e.currentTarget.style.background=C.card)}
              onMouseOut={e => (e.currentTarget.style.background=C.bg)}>
              <div style={{ color:C.red, fontFamily:C.font, fontSize:"18px", marginBottom:"14px" }}>{icon}</div>
